...
void btnCreaFiguraClick(){  
  //Ajusta escala original
  scale=1.0;
  //Ajuste de sliders y parámetros
...
void muestraSecciones(){
  ...
  //Los bordes se dibujan en el plano Z=-1
  //oara que los bordes se dibujen con Z=0
  //y que el list no atraviese el borde y pase por encima
  translate(0,0, -1);
  strokeWeight(2);
  stroke(0);
  //Sección de rotación
  ...
  translate(0, 0, 1);
  //Restaura el noStroke si está habilitado
  if(!params.conStroke) noStroke();
